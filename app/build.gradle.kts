  ...
  signingConfigs {
    create("release") {
      ...
      val envStorePass = System.getenv("KEYSTORE_PASSWORD")?.ifEmpty { null }
        ...
        ?: "android"
      val envKeyAlias = System.getenv("KEY_ALIAS")?.ifEmpty { null } ?: "androiddebugkey"
      val envKeyPass = System.getenv("KEY_PASSWORD")?.ifEmpty { null } ?: envStorePass
      ...
      } else if (uploadKeystore.exists() && uploadKeystore.length() > 0L) {
